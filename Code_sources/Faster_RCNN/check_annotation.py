...
def check(obj_name):
    return  obj_name == 'nom' or obj_name == 'prenom' \
        or obj_name == 'date_naissance' or obj_name == 'date_permis_A1' \
        or obj_name == 'date_permis_A2' or obj_name == 'date_permis_A3' \
...
if __name__ == '__main__':
    ...
    cnt_nom, cnt_prenom, cnt_naissance, cnt_A1, cnt_A2, cnt_A3, cnt_B1, cnt_B = 0, 0, 0, 0, 0, 0, 0, 0
    for i, imagename in enumerate(imagenames):
        ...
        for obj in parse_rec(annopath.format(imagename)):
            ...
            if obj_name == 'date_permis_B':
                cnt_B += 1
        print cnt_nom, cnt_prenom, cnt_naissance, cnt_A1, cnt_A2, cnt_A3, cnt_B1, cnt_B
        if cnt_nom != cnt_prenom or cnt_prenom != cnt_naissance or cnt_naissance != cnt_A1 or cnt_A1 !=cnt_A2 or cnt_A2 !=cnt_A3 \
        or cnt_A3 !=cnt_B1 or cnt_B1!=cnt_B:
    		print imagename
            	break
